...
- 两轮蛇形选秀，每人招募 4 名角色
- 秘密选择角色、中央高亮确认、全员同时翻牌揭晓，连续进行 4 局比赛
- Mild / Wild 赛道交替；Wild 包含箭头、石头和星星
- 36 名角色及其主要能力、连锁触发、绊倒、传送、淘汰和精确冲线；蛋与双生子拥有赛前能力选择
- 36 张规则书原画角色纹理：选秀卡面、比赛 HUD 与 Three.js 纸板立牌统一呈现
- 中央骰子演出、棋子逐格跳步移动、玩家归属名牌和当前行动者高亮
- 设置中随时切换中文翻译或规则书英文原文；每台手机独立保存语言
- 递增奖杯计分与并列获胜
- 单人添加 1–3 名电脑的快速试玩模式
- 首页 60 秒规则说明、可安装 PWA 与手机竖屏触控布局
- 房主权威规则判定和共享赛事日志
...
测试包含：36 名角色逐一覆盖、每个狂野跑道特殊格、绊倒与扶起、传送、反向移动、同格联动、重掷顺序、Sisyphus、Skipper、幕后主脑和 M.O.U.T.H. 残局，以及秘密选角网络视图。压力测试固定跑完 60 场 2–4 人完整游戏（共 240 局比赛），确认 36 名角色全部实际登场、没有死锁，分数与格位始终有效；另外保留 12 组四人和 6 组双人确定性回归种子。项目也已在两个独立浏览器标签页中验证真人房间加入、选秀、秘密出赛、投骰、逐格移动和权威状态同步，并在 390×844 手机视口逐步检查完整比赛 HUD。
