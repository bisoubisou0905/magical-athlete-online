...
测试包含：36 名角色数据完整性、动态 2–4 人两轮蛇形选秀、12 组确定性随机种子的四局完整模拟、重掷触发顺序、Sisyphus、幕后主脑和 M.O.U.T.H. 残局，以及秘密选角网络视图。项目也已在两个独立浏览器标签页中验证真人房间加入与选秀同步，并在 390×844 手机视口逐步检查首页、翻牌、骰子、走子和比赛 HUD。
